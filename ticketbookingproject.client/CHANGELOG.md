...
- Create Angular project with ng: `ng new ticketbookingproject.client --defaults --skip-install --skip-git --no-standalone `.
...
- Create project file (`ticketbookingproject.client.esproj`).
